...
parser = argparse.ArgumentParser(description='Train prototypical networks for asr')
...
parser.add_argument('--data.way', type=int, default=20, metavar='WAY',
                    help="number of classes per episode (default: 20)")
...
parser.add_argument('--model.x_dim', type=str, default='1,160,64', metavar='XDIM',
